...
<body>
    ...
    $FileRead = file_get_contents('../file/file.txt');
    $FileRead1 = explode('; ',$FileRead, -1); ?>
        ...
        <div class="row mt-2 text-center ">
            <div class="col-12">
                <button type="button" onclick="history.back(-1); return false;" name="csv" id="csv"
